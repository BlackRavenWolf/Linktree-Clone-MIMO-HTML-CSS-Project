...
**index.html**
The main HTML file that contains the structure of the Linktree page.

**style.css**
Contains the CSS styling used to design the layout, colors, and visual appearance of the page.
